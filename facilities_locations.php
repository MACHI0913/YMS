    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Facilities Locations</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="welcome.php">Dashboard</a></li>
                        <li class="breadcrumb-item active">Facilities Locations</li>
                    </ul>
                </div>
            </div> 
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="stats-info">
                    ...
                    WHERE department.Dept_name='Facilities'";
            ...
            <div class="col-md-4">
                <div class="stats-info">
                    ...
                    FROM location
                    INNER JOIN department ON location.Dept_ID=department.Department_ID
                    WHERE department.Dept_name='Facilities' AND Availability_status= 1";
                    if ($result=mysqli_query($mysqli, $sqlLocation))
                    {
                        $rowcount=mysqli_num_rows($result);
                        echo "<h4>" .$rowcount. "</h4>";
            ...
            <div class="col-md-4">
                <div class="stats-info">
                    ...
                    FROM location
                    INNER JOIN department ON location.Dept_ID=department.Department_ID
                    WHERE department.Dept_name='Facilities' AND Availability_status BETWEEN 2 AND 4";
                    if ($result=mysqli_query($mysqli, $sqlLocation))
                    {
                        $rowcount=mysqli_num_rows($result);
                        echo "<h4>" .$rowcount. "</h4>";
