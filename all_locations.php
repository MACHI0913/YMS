    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">All Locations</h3>
                    <ul class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-xl-2 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        <h4 class="card-title">FRONT SIDE SPOTS
                            <span class="badge bg-inverse-success ml-1">
                            <?php
                            $sqlLocation = "SELECT * FROM location WHERE Availability_status= 1 AND Location_name BETWEEN 1 AND 48";
                            if ($result=mysqli_query($mysqli, $sqlLocation))
                            {
                                $rowcount=mysqli_num_rows($result);
                                echo "<h4>" .$rowcount. "</h4>";
                        ...
                        <!-- add while loop here-->
                        <?php
                        $query = "SELECT * FROM location WHERE Location_name BETWEEN 1 AND 48";
            ...
            <div class="col-md-6 col-lg-6 col-xl-2 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        <h4 class="card-title">FRONT BAY DOORS
                            <span class="badge bg-inverse-success ml-1">
                            <?php
                            $sqlLocation = "SELECT * FROM location WHERE Availability_status= 1 AND Location_desc LIKE '%DOOR%'";
                            if ($result=mysqli_query($mysqli, $sqlLocation))
                            {
                                $rowcount=mysqli_num_rows($result);
                                echo "<h4>" .$rowcount. "</h4>";
                        ...
                        <!--insert while loop here to grab all the spots -->
                        <?php
                        $query = "SELECT * FROM location WHERE Location_desc LIKE '%DOOR%'";
                        $query_run = mysqli_query($mysqli, $query);
                        ...
                        <div class="leave-info-box">
                            <div class="media align-items-center">
                                ...
                                if ($row['Availability_status'] =='1' )
                                    {
                                        echo "<img alt='Garage Door Part Open icon' srcset='https://img.icons8.com/nolan/40/D9E021/FB872B/garage-door-part-open.png'>";
                                    }
                                else
                                {
                                    echo "<img srcset='https://img.icons8.com/nolan/40/D9E021/FB872B/garage-door.png'>";
                                }
                                    ?>
                                <div class="media-body">
                                    <div class="text-sm my-0"><?php echo $row['Location_name']?></div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-2 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        <h4 class="card-title">BACK BAY DOORS 
                            <span class="badge bg-inverse-success ml-1">
                            <?php
                            $sqlLocation = "SELECT * FROM location WHERE Availability_status= 1 AND Location_name LIKE '%50%'";
                            if ($result=mysqli_query($mysqli, $sqlLocation))
                            {
                                $rowcount=mysqli_num_rows($result);
                                echo "<h4>" .$rowcount. "</h4>";
                        ...
                        <!-- add while loop here-->
                        <?php
                        $query = "SELECT * FROM location WHERE Location_name LIKE '%50%'";
                        $query_run = mysqli_query($mysqli, $query);
                        ...
                        <div class="leave-info-box">
                            <div class="media align-items-center">
                                <!--CHANGE TO ICON-->
                                <img srcset="https://img.icons8.com/nolan/40/D9E021/FB872B/garage-door.png">
                                <div class="media-body">
                                    <div class="text-sm my-0"><?php echo $row['Location_name']?></div>
                                </div>
                            </div>
            ...
            <div class="col-md-6 col-lg-6 col-xl-2 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        <h4 class="card-title">BACK SIDE: D-SIDE 
                            <span class="badge bg-inverse-success ml-1">
                            <?php
                            $sqlLocation = "SELECT * FROM location WHERE Availability_status= 1 AND Location_desc LIKE '%D-side%'";
                            if ($result=mysqli_query($mysqli, $sqlLocation))
                            {
                                $rowcount=mysqli_num_rows($result);
                                echo "<h4>" .$rowcount. "</h4>";
                        ...
                        <!-- add while loop here-->
                        <?php
                        $query = "SELECT * FROM location WHERE Location_desc LIKE '%D-side%'";
                        $query_run = mysqli_query($mysqli, $query);
            ...
            <div class="col-md-6 col-lg-6 col-xl-2 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        <h4 class="card-title">FRONT SIDE: A-SIDE    
                            <span class="badge bg-inverse-success ml-1">
                            <?php
                            $sqlLocation = "SELECT * FROM location WHERE Availability_status= 1 AND Location_desc LIKE '%A-side%'";
                            if ($result=mysqli_query($mysqli, $sqlLocation))
                            {
                                $rowcount=mysqli_num_rows($result);
                                echo "<h4>" .$rowcount. "</h4>";
                        ...
                        <!-- add while loop here-->
                        <?php
                        $query = "SELECT * FROM location WHERE Location_desc LIKE '%A-side%'";
                        $query_run = mysqli_query($mysqli, $query);
            ...
            <div class="col-md-6 col-lg-6 col-xl-2 d-flex">
                <div class="card flex-fill">
                    <div class="card-body">
                        <h4 class="card-title">FRONT SIDE: B-SIDE
                            <span class="badge bg-inverse-success ml-1">
                            <?php
                            $sqlLocation = "SELECT * FROM location WHERE Availability_status= 1 AND Location_desc LIKE '%B-side%'";
                            if ($result=mysqli_query($mysqli, $sqlLocation))
                            {
                                $rowcount=mysqli_num_rows($result);
                                echo "<h4>" .$rowcount. "</h4>";
                        ...
                        <!--insert while loop here to grab all the spots -->
                        <?php
                        $query = "SELECT * FROM location WHERE Location_desc LIKE '%B-side%'";
                        $query_run = mysqli_query($mysqli, $query);
